...
function TodoList() {
  ...
  useEffect(() => {
    const data = [{id: 0, text: '산책가기', completed: false},
                  {id: 1, text: '멋사과제', completed: true},  
                  {id: 2, text: '야구보기', completed: false}
  ...
  useEffect(() => {
    ...
    const n_arr = todos.filter((todo) => todo.completed===true);
    setCount(n_arr.length);
  }, [todos]);
